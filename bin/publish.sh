...
file_prefix="stash-disapprove-plugin-"
deploy_prefix="com.palantir.stash/stash-disapprove-plugin"
release_prefix="pt-releases/atlassian/stash-disapprove-plugin"
release_filename="stash-disapprove-plugin.jar"
